...
// TODO: import tables
import {Position,PositionTableId,Player,Health,Damage,PositionData} from "../codegen/Tables.sol";
...
contract AttackSystem is System {
  function attack(int32 x, int32 y) public {
    ...
    PositionData[] memory neighbors = moreNeighborhood(PositionData(x, y)); 
...
function moreNeighborhood(PositionData memory center) internal pure returns (PositionData[] memory) {
